...
export default function Shop() {
  ...
  const t = {
    ...
    hindi: {
      ...
      thanksForPurchase:
        "आपकी खरीदारी के लिए धन्यवाद! आपके प्रोडक्ट्��� डाउनलोड के लिए तैयार हैं।",
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              {language === "hindi"
                ? "प्रीमियम टूल्स को खरीदने से पहले आपको अपनी ��्रिएटर प्रोफाइल बनानी ���ोगी। यह केवल 2 मिनट में हो जाएगा!"
