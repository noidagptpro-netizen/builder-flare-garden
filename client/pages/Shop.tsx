...
${language === "hindi" ? "मैं [आपका नाम] हूं, [आपकी निच] में एक कंटेंट क्रिएटर हूं जिसके [प्लेटफॉर्म] ���र [फॉलोअर संख्या] फॉलोअर्स हैं।" : "I'm [Your Name], a content creator in [Your Niche] with [Follower Count] followers on [Platform]."}
            ...
            <div className="bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-200 rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-4">
                    {language === "hindi"
                      ? "0 से 10K फॉलोअर्स तक बढ़ने और मुद्रीकर�� शुरू करने के लिए आपको चाहिए सब कुछ"
