  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "🤝 मुद्रीकरण और स्केलिंग: ब्रांड कोलैबोरेशन नही��� मिल पाना",
      ...
      goals: [
        ...
        "इंडस्ट���री इवेंट्स/पॉडकास्ट में बोलना",
...
${language === "hindi" ? "टेम्प्ल���ट 1: प्रारंभिक संप��्क (कोल्�� आउटरीच)" : "TEMPLATE 1: INITIAL OUTREACH (COLD EMAIL)"}
