  ...
  hindi: {
    ...
    options: {
      ...
      goals: [
        ...
        "��पन��ं के ब्रांड्स के साथ पार्टन��शिप",
...
${language === "hindi" ? "टेम्����्लेट 4: न���गोसिएशन/��ाउंटर ऑफर" : "TEMPLATE 4: NEGOTIATION/COUNTER OFFER"}
...
${language === "hindi" ? "• Grateful और humble र��ें" : "• Be grateful and humble"}`;
