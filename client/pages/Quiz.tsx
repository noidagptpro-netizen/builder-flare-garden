  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "💔 मुद्रीक���ण और स्केलिंग: फॉलोअर्स को पेइंग कस्टमर में नहीं बदल पाना",
...
${language === "hindi" ? "टेम्प्लेट 2: ���ॉलो-���प ईमेल" : "TEMPLATE 2: FOLLOW-UP EMAIL"}
...
${language === "hindi" ? "- अन्य क्रिएटर्स के साथ को���ैबोरेशन शुरू ���रें" : "- Start collaborations with other creators"}
