...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      secondaryPlatforms:
        "आप और कौन से प्लेटफॉर्म का उपयोग करते हैं? (��ई विकल्प चुनें)",
      ...
      goals: "आपके ���गले 6 महीने के मुख्य लक्ष्य क���या हैं? (अधिकतम 3 चुनें)",
    ...
    freeResources: {
      ...
      mediaKit: {
        ...
        description: "आकर्षक मीडिया कि��� बन���एं जो ब्रांड्स को पसंद आएंगे",
      },
      emailTemplates: {
