  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "📊 मुद्रीकरण और स्के���ि��ग: एनालिटिक्स और मेट्रिक्स से कन्फ्यूज़न",
...
${language === "hindi" ? "पोस्टिंग आवृ���्ति:" : "Posting Frequency:"} ${quizData.postingFrequency}
...
${language === "hindi" ? "आपकी interest ��े लि��� धन्यवाद! यहां मे��े collaboration packages हैं:" : "Thank you for your interest! Here are my collaboration packages:"}
