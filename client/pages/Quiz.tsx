  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "कई ���्लेटफॉर्म ��ो efficiently मैनेज करना",
      ],
      goals: [
        ...
        "अपनी स्पे��� में दूसरे क्रिएटर्स को mentor करना",
      ],
    },
    buttons: {
      next: "अगला कदम",
    ...
    freeResources: {
      title: "🎉 क्विज़ प��रा! ��हा�� हैं आपके मु��्त क्रिएटर संसाधन",
      subtitle:
...
${language === "hindi" ? "क्या आप इस opportunity को explore क���ने में interested हैं?" : "Would you be interested in exploring this opportunity?"}
...
${language === "hindi" ? "वर्त���ान स्थिति:" : "Current Status:"} ${quizData.followerCount} on ${quizData.primaryPlatform}
...
${language === "hindi" ? "- अन्य क्रिएटर्स ��े साथ कोलैबोरेशन शुरू करें" : "- Start collaborations with other creators"}
