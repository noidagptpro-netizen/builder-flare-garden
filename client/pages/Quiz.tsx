...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      experience:
        "आप कितने समय से कंटेंट बना रहे हैं? (सभी स्तर चुनें जिनका आपन�� अनुभव किया है)",
...
${language === "hindi" ? "- मैं प्रामाणिक कंटेंट बनाने में वि���ेषज्ञ हूं" : "- I specialize in creating authentic content"}
...
${language === "hindi" ? "हैलो [���ंपर्क नाम]," : "Hi [Contact Name],"}
...
${language === "hindi" ? "टेम्���्ले�� 4: न��गोसिएशन/काउंटर ऑफर" : "TEMPLATE 4: NEGOTIATION/COUNTER OFFER"}
...
${language === "hindi" ? `- ${quizData.postingFrequency === "Daily" ? "अपनी वर्तमान आवृत्ति बनाए रखे���" : "पोस्टिंग आवृत्ति बढ़ाकर दैनिक करें"}` : `- ${quizData.postingFrequency === "Daily" ? "Maintain your current posting frequency" : "Increase posting frequency to daily"}`}
...
${language === "hindi" ? "अपेक्षि��� परिणाम (90 दिन):" : "EXPECTED RESULTS (90 days):"}
