...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      experience:
        "आप कितने समय से क���टेंट बना रहे हैं? (सभी स्तर चुने��� जिनका आपने अनुभव किया है)",
    ...
    options: {
      ...
      challenges: [
        ...
        "🤝 म��द्रीकरण और स्केलिंग: ब्रांड कोलैबोरेशन नही��� मिल पाना",
      ...
      goals: [
        ...
        "इंडस���ट्री इवेंट्स/पॉडकास्ट में बोलना",
...
${language === "hindi" ? "- मैं प्र���माणिक कंटेंट बनाने म��ं विशेषज्ञ हूं" : "- I specialize in creating authentic content"}
...
${language === "hindi" ? "- क���्युनिटी एंगेजमेंट फोक��� करें" : "- Focus on community engagement"}
