...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      monthlyIncome: "कंटें��� से आपकी वर्तम���न मासिक आय क्या है?",
    ...
    options: {
      ...
      challenges: [
        ...
        "🤝 ब्रांड और पहचान: प्रामाणिकता और ब्रांड अपील के बीच संतुलन",
      ...
      goals: [
        ...
        "अपने निच में गो-टू एक्स���र्ट बनना",
    ...
    freeResources: {
      title: "🎉 क्विज़ पूरा! यहाँ हैं ��पके मुफ्त क्रिएटर संसाधन",
      subtitle:
...
${language === "hindi" ? "��िच:" : "Niche:"} ${quizData.niche}
...
- YouTube: ${quizData.socialLinks.youtube || "[Your YouTube]"}`;
      ...
      content =
        fontSizeIndicator +
        `${language === "hindi" ? "6+ ब्रा���ड आ���टरीच ईमेल टेम्प्लेट्स" : "6+ BRAND OUTREACH EMAIL TEMPLATES"} - ${userName}
...
${language === "hindi" ? "टेम्प्ल��ट 2: फॉलो-���प ईमेल" : "TEMPLATE 2: FOLLOW-UP EMAIL"}
...
${language === "hindi" ? "मुझे future collaborations में interest ���ै और आपके products को authentically promote करना पसंद ह���।" : "I'm interested in future collaborations and love authentically promoting your products."}
...
${language === "hindi" ? "- अन्य क्रिएटर्स के साथ कोलैबोर���शन शुरू ���रें" : "- Start collaborations with other creators"}
