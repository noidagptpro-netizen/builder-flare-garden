...
const languages = {
  english: {
    ...
    questions: {
      ...
      goals: "आपके अगले 6 मह��ने के मुख्य लक्ष्य क्या हैं? (अधिकतम 3 चुनें)",
  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "🤝 मुद्रीकरण और स���केलिंग: ब्रांड कोलैबोरेशन नहीं मिल पाना",
    ...
    freeResources: {
      ...
      subtitle:
        "अपनी क्रिएटर यात्रा शुरू क���ने के लिए ��न शक्तिशाली टूल्�� को डाउनलोड करें",
      mediaKit: {
...
${language === "hindi" ? "- आपके उत्���ाद मेरे दर्शकों के साथ पूरी तर��� ���ेल खाते हैं" : "- Your products align perfectly with my audience"}
