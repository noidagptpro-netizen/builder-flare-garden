...
${language === "hindi" ? "📦 पैक��ज दरें:" : "📦 PACKAGE RATES:"}
...
${language === "hindi" ? "टे��्प्���ेट 2: फॉलो-����प ईमेल" : "TEMPLATE 2: FOLLOW-UP EMAIL"}
...
${language === "hindi" ? "टेम्प्लेट 5: प��फॉर्म���ंस रिपो���्ट" : "TEMPLATE 5: PERFORMANCE REPORT"}
...
${language === "hindi" ? "- अन्य क्रिएटर्�� के साथ कोलैबोरेशन शुरू ���रें" : "- Start collaborations with other creators"}
