...
const languages = {
  english: {
    ...
    questions: {
      ...
      goals: "���पके अगले 6 महीन��� के मुख्य लक्ष्य क्या हैं? (अधिकतम 3 चुनें)",
  ...
  hindi: {
    ...
    options: {
      ...
      goals: [
        ...
        "सपनों के ब्रांड्स के ���ाथ पार्टनरशिप",
    ...
    freeResources: {
      title: "🎉 क्विज़ पूरा! यहाँ हैं ���पके मुफ्त क्र���एटर संसा��न",
      subtitle:
...
${language === "hindi" ? "क्या आप स���योग के अवसरों पर ���र��चा करने के लिए सम��� निकाल ���कते हैं?" : "Would you be available to discuss collaboration opportunities?"}
...
${language === "hindi" ? "- ��ंगे��मेंट में स�����धार: 50-100%" : "- Engagement Improvement: 50-100%"}
