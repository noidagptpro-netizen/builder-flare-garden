...
${language === "hindi" ? "सांख्यिकी ���र द�����ं:" : "STATISTICS & RATES:"}
...
${language === "hindi" ? "- म���ं प्रामाणिक कंटेंट बनाने म��ं विश��षज्�� हूं" : "- I specialize in creating authentic content"}
...
${language === "hindi" ? "बोन��� टिप्स:" : "BONUS TIPS:"}
                ...
                {currentStep === 10 && (
                  <div className="space-y-10">
                    <div className="text-center mb-12">
                      ...
                      <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        {language === "hindi"
                          ? "आप अगले 6 म���ीनों ���ें क्या हासि��� करन��� चाहते हैं? 3 लक्ष्य चुनें जो आपको सबसे ज������ादा उत्साहित करते है���!"
