...
const languages = {
  english: {
    ...
    questions: {
      ...
      goals: "आपके अ���ले 6 महीन��� के मुख्य लक्ष्य क्या हैं? (अधिकतम 3 चुनें)",
  ...
  hindi: {
    ...
    questions: {
      ...
      engagementRate: "आपका औसत एंगेजमेंट र���ट क्या है? Engagement rate = (likes + comments + shares) / followers",
      biggestChallenge:
    ...
    options: {
      ...
      goals: [
        ...
        "सपनों के ब्रांड्स के साथ पा���्टनरशिप",
    ...
    freeResources: {
      title: "🎉 क्विज़ पूरा! यहाँ हैं ���पके मुफ्त क्रिएटर स���सा��न",
      subtitle:
...
${language === "hindi" ? "क्या आप स���योग के अवसरों पर ���र��चा करने के लिए समय निका��� ���कते हैं?" : "Would you be available to discuss collaboration opportunities?"}
...
${language === "hindi" ? "- ��ंगेजमेंट ��ें स�����धार: 50-100%" : "- Engagement Improvement: 50-100%"}
