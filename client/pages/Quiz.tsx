...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      biggestChallenge:
        "एक क्रिएटर के रूप में आपकी सबसे बड़ी चुनौतियां क्या ���ैं? (अधिकतम 3 चुनें)",
      goals:
    ...
    options: {
      ...
      goals: [
        ...
        "10K सब्सक्राइबर्�� की email ल��स्ट",
    ...
    freeResources: {
      ...
      emailTemplates: {
        title: "ब्रांड आउटरीच ईम��ल टेम्प्लेट्स",
