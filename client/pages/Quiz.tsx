...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      socialLinks: "अपनी सोशल उपस्थि��ि साझा करें (वैकल्पिक)",
...
${language === "hindi" ? "���ुझे आपके ���्रांड के साथ काम करने में दिलचस्पी है क्योंकि:" : "I'd love to work with your brand because:"}
...
${language === "hindi" ? "क्या आप स���य���ग के अवसरों पर ���र��चा करने के लिए समय निकाल ���कते हैं?" : "Would you be available to discuss collaboration opportunities?"}
...
${language === "hindi" ? "टेम्प्लेट 5: परफॉर्में�� रिपो���्ट" : "TEMPLATE 5: PERFORMANCE REPORT"}
...
${language === "hindi" ? "- अन्य क्रिएटर्स के सा��� कोलैबोरेशन शुरू ���रें" : "- Start collaborations with other creators"}
