...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      niche: "��पका कंटेंट किस विषय पर है?",
      ...
      socialLinks: "��पनी सोशल उपस्थिति साझा करें (वैकल्पिक)",
      bio: "अपने और अपने कंटेंट के बारे में कु�� और बताएं (वैकल्पिक)",
    },
    options: {
      platforms: [
        "���ंस्टाग्र��म",
    ...
    freeResources: {
      ...
      emailTemplates: {
        title: "ब्रांड ���उटरीच ईमेल टेम्प���लेट्स",
...
${language === "hindi" ? "�����ंख्यिकी:" : "Statistics:"}
