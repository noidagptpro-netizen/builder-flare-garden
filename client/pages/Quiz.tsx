  ...
  hindi: {
    ...
    options: {
      ...
      goals: [
        ...
        "अपनी 9-5 जॉब छोड़���र फुल-टाइम जाना",
    ...
    freeResources: {
      ...
      emailTemplates: {
        title: "ब्रांड आउटरीच ईमेल टेम्प���ल���ट्स",
...
${language === "hindi" ? `- मेरे दर्��क ${quizData.niche} में रुचि रखते हैं` : `- My audience is interested in ${quizData.niche}`}
...
${language === "hindi" ? "- कम��युनिटी एंगेजमेंट फोक��� करें" : "- Focus on community engagement"}
