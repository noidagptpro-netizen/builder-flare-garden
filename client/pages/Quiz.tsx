...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      secondaryPlatforms:
        "आप और कौ��� से प्लेटफॉर्म का उपयोग करते हैं? (कई विकल्प चुनें)",
    ...
    freeResources: {
      ...
      subtitle:
        "अपनी क्र��एटर यात्रा शुरू करने के लिए इ�� शक्तिशाली ट���ल्स को डाउनल���ड ���रे��",
      mediaKit: {
...
${language === "hindi" ? "मुझे आपके ���्रांड क��� साथ काम करने में दिलचस्पी है क्योंकि:" : "I'd love to work with your brand because:"}
