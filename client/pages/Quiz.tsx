...
const languages = {
  ...
  hindi: {
    ...
    subtitle: "3 मिनट में अपनी व्यक्तिगत ग���रोथ रणनीति पाएं",
    steps: {
    ...
    questions: {
      ...
      postingFrequency: "आप कितनी बार कंटेंट पोस्ट कर��े हैं?",
      experience:
    ...
    freeResources: {
      title: "🎉 क्विज़ प��रा! यहा�� हैं आपके मु��्त क्रिएटर संसा��न",
      subtitle:
...
${language === "hindi" ? `- ${quizData.primaryPlatform === "Instagram" ? "रील्स पर फोकस करें (60% कंटेंट)" : "प्लेटफॉर्��-स्पेसिफिक कंटेंट बढ़ाएं"}` : `- ${quizData.primaryPlatform === "Instagram" ? "Focus on Reels (60% content)" : "Increase platform-specific content"}`}
