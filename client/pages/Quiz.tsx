...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      secondaryPlatforms:
        "आप और कौन से प���लेटफॉर्म का उपयोग करते हैं? (कई विकल्प चुनें)",
      ...
      socialLinks: "अपनी सोशल उपस्थिति साझा ��रें (वैकल्पिक)",
...
${language === "hindi" ? "मुझे आ��के ���्रांड के साथ काम करने में दिलचस्पी है क्योंकि:" : "I'd love to work with your brand because:"}
...
${language === "hindi" ? "क्या आप स���योग के अ���सरों पर ���र��चा करने के लिए समय निकाल ���कते हैं?" : "Would you be available to discuss collaboration opportunities?"}
...
${language === "hindi" ? "- अन्य क्रिएटर्स के साथ कोलै��ोरेशन शुरू ���रें" : "- Start collaborations with other creators"}
