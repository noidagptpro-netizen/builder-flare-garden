...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      goals:
        "अगले 6 महीनो��� के लिए आपके मुख्य लक्ष्य क��या हैं? (अधिकतम 3 चुनें)",
    ...
    options: {
      ...
      goals: [
        ...
        "इंडस्ट्री ���वेंट्स/पॉडकास��ट्स में बोलना",
    ...
    freeResources: {
      ...
      subtitle:
        "अपनी क्रिएटर यात्रा शुरू करने के लिए इ�� शक्तिशाली ट���ल्स को डाउनलोड ���रे��",
      mediaKit: {
        title: "प्रोफेशनल मीडिया किट टेम्प्लेट",
        description: "आकर����षक मीडिया किट बनाएं जो ब्���ांड्स को पसंद आएंगे",
      },
      emailTemplates: {
...
${language === "hindi" ? "• बेसिक पैकेज (1 ��ोस्ट + 2 स्टोरी):" : "• Basic Package (1 Post + 2 Stories):"} ₹${quizData.followerCount.includes("Less than 1K") ? "400-800" : quizData.followerCount.includes("1K - 5K") ? "800-1,500" : "1,500-4,000"}
...
${language === "hindi" ? "टेम्प्लेट 1: ��्रारंभिक संपर्क (कोल्ड आउटरीच)" : "TEMPLATE 1: INITIAL OUTREACH (COLD EMAIL)"}
...
${language === "hindi" ? "टेम्प्लेट 2: फॉलो-अप ई��ेल" : "TEMPLATE 2: FOLLOW-UP EMAIL"}
...
${language === "hindi" ? "हम���रे recent collaboration के results share करना चाहता हूं:" : "I wanted to share the results from our recent collaboration:"}
...
${language === "hindi" ? "• Subject lines क��� catchy रखें" : "• Keep subject lines catchy"}
