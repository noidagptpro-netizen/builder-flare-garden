...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      secondaryPlatforms:
        "आप और कौन से प्ल��टफॉर्म का उपयो�� करते हैं? (कई विकल्प चुनें)",
      ...
      goals: "��पके अगले 6 महीने के मुख����� लक्ष्य क्या हैं? (अधिकतम 3 चुनें)",
...
${language === "hindi" ? "टेम्प्ल���ट 1: प्रारंभिक संपर्क (कोल���� आउटरीच)" : "TEMPLATE 1: INITIAL OUTREACH (COLD EMAIL)"}
...
${language === "hindi" ? "🎥 रील्स कंटेंट: ₹[आ��की rate]" : "���� Reels Content: ₹[Your rate]"}
...
${language === "hindi" ? "- इंटरैक्टिव कंटे���ट बढ़ाएं (पो��्स, Q&A)" : "- Increase interactive content (polls, Q&A)"}
