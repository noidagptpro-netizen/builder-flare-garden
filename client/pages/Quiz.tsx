...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      postingFrequency: "आप कितनी बार कंटेंट पोस्ट करत�� हैं?",
      experience:
      ...
      goals:
        "अगले 6 महीनो��� के लिए आपके मुख्य लक्ष्य क्या हैं? (अध���कतम 3 चुनें)",
    ...
    options: {
      ...
      challenges: [
        ...
        "ऑथेंटिसिटी और ब्रांड अपील का सं���ुलन",
        "बड़े क्���िएटर्स से कॉम्पिटिशन",
        "फॉलोअर्स को पेइंग कस्टमर बनाना",
        "नेगेटिव कमेंट्स/ट्रोल्स से निपटना",
        "बर्न���उट और कंटेंट थकान",
        "एनालिटिक्�� ��र मेट्रिक्स स����झना",
      ...
      goals: [
        ...
        "नए प्लेटफॉर��म्स/फॉर्मेट���स में expand करना",
...
${language === "hindi" ? "• प्रीमियम पैकेज (2 ���ोस्ट + 1 रील + 3 स���टोरी):" : "• Premium Package (2 Posts + 1 Reel + 3 Stories):"} ₹${quizData.followerCount.includes("Less than 1K") ? "1,200-2,500" : quizData.followerCount.includes("1K - 5K") ? "2,500-4,500" : "4,500-12,000"}
...
${language === "hindi" ? "विषय:" : "Subject:"} ${language === "hindi" ? `सहयोग का प्रस्ताव - ${userName} X [ब्रांड न��म]` : `Collaboration Proposal - ${userName} X [Brand Name]`}
...
${language === "hindi" ? "- मैं प्रामाणिक कंटेंट ब���ाने में विशेषज्ञ हूं" : "- I specialize in creating authentic content"}
...
${language === "hindi" ? "आपकी interest ��े लिए धन्यवाद! यहा�� मे��े collaboration packages हैं:" : "Thank you for your interest! Here are my collaboration packages:"}
...
${language === "hindi" ? `- ${quizData.postingFrequency === "Daily" ? "अपनी वर्तमान आवृत्���ि बनाए रखें" : "पोस्टिंग आवृत्ति बढ़ाकर दैनिक करें"}` : `- ${quizData.postingFrequency === "Daily" ? "Maintain your current posting frequency" : "Increase posting frequency to daily"}`}
