...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      socialLinks: "अपनी सोश��� उपस्थिति साझा करें (वैकल्पिक)",
    ...
    freeResources: {
      title: "🎉 क्विज़ प��रा! यहा�� हैं आ��के मु��्त क्रि���टर संसाधन",
      subtitle:
...
${language === "hindi" ? "क्���ा आप स���योग के अवसरों पर ���र��चा करने के लिए समय निकाल ���कते हैं?" : "Would you be available to discuss collaboration opportunities?"}
...
${language === "hindi" ? "Recently मैंने [competitor brand] के साथ work क���या और ���स post ���ो [specific results] मिले।" : "Recently I worked with [competitor brand] and that post received [specific results]."}
...
${language === "hindi" ? "वर्तमान स���थिति:" : "Current Status:"} ${quizData.followerCount} on ${quizData.primaryPlatform}
...
${language === "hindi" ? "- अन्य क्रि���टर्स के साथ कोलैबोरेशन शुरू ���रें" : "- Start collaborations with other creators"}
