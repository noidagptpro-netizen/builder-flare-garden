...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      followerCount: "आ���के प्राथमिक प्लेटफॉर्म पर कितने फॉलोअर्स हैं?",
      secondaryPlatforms:
    ...
    freeResources: {
      title: "🎉 क्���िज़ पूरा! यहाँ हैं आपके मुफ्त क्रिएटर संसाधन",
      subtitle:
        "अपनी क्रिएटर यात्रा श��रू करने के लिए इन शक्तिशाली टूल्स को डाउनलोड करें",
      mediaKit: {
...
${language === "hindi" ? "- हैशटैग रिसर्च करें (30 ��ैशटैग मिक्स)" : "- Research hashtags (30 hashtag mix)"}
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-2xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "व्यक्तिगत SWOT विश्लेषण, विका��� रणनीति, और प्र��मियम टूल्स के साथ अपनी क्रिएटर यात्���ा को तेज़ी से आगे ब���़ाएं।"
