  ...
  hindi: {
    ...
    freeResources: {
      ...
      growthGuide: {
        ...
        description: "अपने फ��लोइंग बढ़ा���े के लिए ���्टेप-बाई-स्टेप र���डमैप",
      },
...
${language === "hindi" ? "प्रिय [ब्रांड ���ाम] ��ीम," : "Dear [Brand Name] Team,"}
...
${language === "hindi" ? "• Grateful और humble ��हें" : "• Be grateful and humble"}`;
