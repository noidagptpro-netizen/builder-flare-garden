  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "बर्न���उट और कंटेंट थकान",
        "एनालिटिक्�� और मेट्रिक्स स���झना",
        "स���्ची कम्युनिटी बनाना",
        "ट���रेंड्स के साथ रिलेवेंट रहना",
      ...
      goals: [
        ...
        "9-5 job छ��ड़कर फुल-टाइम जाना",
        "नए प्लेटफॉर��म्स/फॉर्मेट्स में expand करना",
        "अपनी स्पे��� में दूसरे क���रिएटर्स को mentor करना",
      ],
    },
    buttons: {
      next: "अगला कदम",
      back: "पिछला",
      submit: "मेरा क्रिए���र विश्लेषण पाएं",
    },
    freeResources: {
      ...
      growthGuide: {
        ...
        description: "अपने फॉलोइंग बढ़ाने के लिए ���्टेप-बाई-स्ट���प र���डमैप",
      },
...
${language === "hindi" ? `मैं ${userName} हूं, ${quizData.niche} में एक कंटेंट क्रिएटर हूं ���िसके ${quizData.primaryPlatform} पर ${quizData.followerCount} फॉलोअ��्स हैं।` : `I'm ${userName}, a content creator in ${quizData.niche} with ${quizData.followerCount} followers on ${quizData.primaryPlatform}.`}
...
${language === "hindi" ? "टेम्���्लेट 4: नेगोसिएशन/काउंटर ऑफर" : "TEMPLATE 4: NEGOTIATION/COUNTER OFFER"}
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-2xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "व्यक्तिगत SWOT विश्लेषण, विका��� रणनीति, और प्रीमियम टूल्स के साथ अपनी क्रिएटर यात्रा को तेज���ी से आगे बढ़ाएं।"
