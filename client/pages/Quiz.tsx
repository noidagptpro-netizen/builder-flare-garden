...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      experience:
        "आप क��तने समय से कंटेंट बना रहे हैं? (सभी स्तर चुने��� जिनका आपने अनुभव किया है)",
      ...
      bio: "अपने और अपने कंटेंट के बारे ����ें कुछ और ब��ाएं (वैकल्पि��)",
    },
    options: {
      platforms: [
        "इंस्टाग्राम",
      ...
      challenges: [
        ...
        "🗣️ ब्रांड और पहचान: अपनी अन��ठी आवाज़/शैली खोजने में संघर्ष",
        "🤝 ब्रांड और पहचान: प्रामाणिकता और ब्रांड अपील के बीच स���तुलन",
      ...
      goals: [
        ...
        "सपनों के ब्र��ंड्स के साथ पार्टनरशिप",
        "अपना प्रोडक्ट/कोर्स लॉन्च करना",
        "अपने निच में गो-टू एक्सपर्ट बनना",
