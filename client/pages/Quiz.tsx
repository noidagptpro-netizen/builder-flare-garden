  ...
  hindi: {
    ...
    options: {
      ...
      goals: [
        ...
        "अपनी स्��े��� में दूसरे क्रिएटर्स को mentor करना",
      ],
    },
    buttons: {
      next: "अगला कदम",
    ...
    freeResources: {
      ...
      growthGuide: {
        ...
        description: "अपने फॉलोइंग बढ़ाने के लि�� ���्टेप-बाई-स्टेप र���डमैप",
      },
...
${language === "hindi" ? `मैं ${userName} हूं, ${quizData.niche} में एक कं��ेंट क्रिएटर हूं जिसके ${quizData.primaryPlatform} पर ${quizData.followerCount} फॉलोअ��्स हैं।` : `I'm ${userName}, a content creator in ${quizData.niche} with ${quizData.followerCount} followers on ${quizData.primaryPlatform}.`}
...
${language === "hindi" ? "- ट्रेंडिंग ट���पिक्स पर कंटेंट बनाएं" : "- Create content on trending topics"}
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-2xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "व्यक्तिगत SWOT विश्लेषण, विका��� रणनीति, और प्रीमियम टूल्स के साथ अपनी क्रि��टर यात्रा को तेज़ी से आगे बढ़ाएं।"
