...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      primaryPlatform: "आप मुख्यतः किस प्लेटफॉर्म पर कंटेंट बनाते ह���ं?",
      ...
      biggestChallenge:
        "एक क्रिएटर के रूप में आपकी सबसे बड़ी चुनौतियां क्या हैं? (अध���कतम 3 चुनें)",
      goals:
    ...
    options: {
      ...
      challenges: [
        ...
        "ए���्गोरिदम बदलाव से पहुंच में कमी",
      ...
      goals: [
        ...
        "10K सब्��क्राइबर्�� की email लिस्ट",
    ...
    freeResources: {
      ...
      mediaKit: {
        title: "प्रोफेशनल मीडिया ���िट टेम्प्लेट",
...
- YouTube: ${quizData.socialLinks.youtube || "[Your YouTube]"}`;
      ...
      content =
        fontSizeIndicator +
        `${language === "hindi" ? "6+ ब्रांड आउटरीच ईमेल टेम��प्लेट्स" : "6+ BRAND OUTREACH EMAIL TEMPLATES"} - ${userName}
...
${language === "hindi" ? "क्या हम इस week एक quick 15-minute call schedule कर सकते है���?" : "Could we schedule a quick 15-minute call this week?"}
