  ...
  hindi: {
    ...
    options: {
      ...
      challenges: [
        ...
        "🤝 म��द्रीकरण और स्केलिंग: ब्रांड कोलैबोरेशन नहीं मिल पाना",
        "📊 मुद्रीकरण और स्के���िंग: एनालिटिक्स और मेट्रिक्स से कन्फ्यूज़न",
      ...
      goals: [
        ...
        "अपनी 9-5 जॉब छ��ड़कर फुल-टाइम जाना",
    ...
    freeResources: {
      ...
      mediaKit: {
        ...
        description: "��कर्षक मीडिया किट बन���एं जो ब्रांड्स को पसंद आएंगे",
      },
      emailTemplates: {
...
${language === "hindi" ? "विषय:" : "Subject:"} ${language === "hindi" ? `सह��ोग का प्रस्ताव - ${userName} X [ब्रांड नाम]` : `Collaboration Proposal - ${userName} X [Brand Name]`}
...
${language === "hindi" ? "दिन 1-30: बुन�������ाद म��बूत ���रना" : "DAYS 1-30: FOUNDATION BUILDING"}
                ...
                {currentStep === 7 && (
                  <div className="space-y-10">
                    <div className="text-center mb-12">
                      ...
                      <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        {language === "hindi"
                          ? "आप अगले 6 महीनों में क्या हासि��� करना चाहते हैं? 3 लक्ष्य चुनें जो आपको सबसे ज्यादा उत्साहित करते हैं!"
