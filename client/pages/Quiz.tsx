...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      experience:
        "आप कित��े समय से कंटेंट बना रहे ���ैं? (सभी स्तर चुने��� जिनका आपने अनुभव किया ह���)",
      monthlyIncome: "कंटेंट से आप���ी वर्तम���न मासिक आय क्या है?",
      engagementRate: "आपका औसत एंग���जमेंट रेट क्या है? Engagement rate = (likes + comments + shares) / followers",
      biggestChallenge:
    ...
    freeResources: {
      ...
      growthGuide: {
        ...
        description: "अपने फॉलोइंग बढ़ाने के लिए स्टेप-���ाई-स्टेप रोडमैप",
      },
...
${language === "hindi" ? "सुझावित दरें (भार��ीय बाजार के आधार पर):" : "SUGGESTED RATES (Based on Indian Market):"}
