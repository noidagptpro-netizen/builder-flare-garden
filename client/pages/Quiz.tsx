...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      followerCount: "आपके प्राथमिक प्ले���फॉर्म पर कितने फॉलोअर्स हैं?",
      secondaryPlatforms:
      ...
      biggestChallenge:
        "आपकी सबस��� बड़ी चुनौती क��या है? 3 तक चुनें – हम सब इसमें एक साथ हैं! आपकी परेशानियों को स��झना हमें बेहतर समाधान देने में मदद करता है।",
...
${language === "hindi" ? "मुझे आपक��� ���्रा��ड के साथ काम कर��े में द���लच��्पी है क्योंकि:" : "I'd love to work with your brand because:"}
...
${language === "hindi" ? "क्या आप ������योग के अवसरों पर �����र��चा करने के लिए समय निकाल ���कते हैं?" : "Would you be available to discuss collaboration opportunities?"}
...
${language === "hindi" ? "• Grateful और humble रहे���" : "• Be grateful and humble"}`;
...
${language === "hindi" ? `- ${quizData.postingFrequency === "Daily" ? "अपनी वर्���मान आवृत्त��� बनाए रखें" : "पोस्टिंग आवृत्ति बढ़��कर द���निक करें"}` : `- ${quizData.postingFrequency === "Daily" ? "Maintain your current posting frequency" : "Increase posting frequency to daily"}`}
