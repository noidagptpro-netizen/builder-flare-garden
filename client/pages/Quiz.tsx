...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      primaryPlatform: "आप मुख्यतः किस प्लेटफॉर्म प��� कंटेंट ब��ाते हैं?",
      followerCount: "आपके प्राथमिक प्लेटफॉर्म पर कितने फॉलोअर्स हैं?",
      secondaryPlatforms:
        "आप और कौन से प्ल��टफॉर्म का उपयोग करते हैं? (कई विकल्प चुनें)",
...
${language === "hindi" ? "📱 स्ट���री पैक���ज: ₹[आप��ी rate]" : "📱 Story Package: ��[Your rate]"}
...
${language === "hindi" ? "- अन्य क्रिएटर्स के साथ कोलैबो���ेशन शुरू ���रें" : "- Start collaborations with other creators"}
