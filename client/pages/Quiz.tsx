...
const languages = {
  ...
  hindi: {
    ...
    questions: {
      ...
      socialLinks: "अपनी सोशल उपस्थिति ��ा��ा करें (वैकल्पिक)",
    ...
    freeResources: {
      ...
      growthGuide: {
        title: "90-दिन की ग्र��थ स्ट्रैटेजी गाइड",
...
export default function Quiz() {
  ...
  const handleBack = () => {
    if (currentStep > 1) {
      setCurrentStep(currentStep - 1);
      // Auto-scroll to top of the page when moving back
      setTimeout(() => {
        window.scrollTo({ top: 0, behavior: "smooth" });
      }, 100);
    }
...
${language === "hindi" ? "- फॉलोअर्स:" : "- Followers:"} ${quizData.followerCount}
${language === "hindi" ? "- कंटेंट प्रकार:" : "- Content Type:"} ${quizData.contentType}
${language === "hindi" ? "- प��स्टिंग आवृत��ति:" : "- Posting Frequency:"} ${quizData.postingFrequency}
...
${language === "hindi" ? "क्या आप इस opportunity क��� explore करने में interested हैं?" : "Would you be interested in exploring this opportunity?"}
...
${language === "hindi" ? "वर्तमान स्थि��ि:" : "Current Status:"} ${quizData.followerCount} on ${quizData.primaryPlatform}
...
${language === "hindi" ? "- अन्य क्रिएटर्स के साथ को��ैबोरेशन शुरू करें" : "- Start collaborations with other creators"}
