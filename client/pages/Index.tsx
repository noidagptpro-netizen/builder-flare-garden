...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑडियंस, और विक���स क्षमता का AI-powered विश्लेषण जिसमें कार्यशील सुझाव हैं।",
          badge: "✓ तुरंत PDF रिपोर्ट",
        },
        mediaKit: {
          title: "प्रोफेशनल मीडिया किट",
          description:
            "आपके आंकड़ों, ऑडियंस डेमोग्राफिक्स, और रेट कार्ड के साथ कस्टम-डिज़ाइन मीडिया किट टेम्प्लेट।",
      ...
      premiumUpgrade: {
        ...
        title: "कम्प्लीट क्रिएटर बिजन���स किट - ₹497",
        subtitle:
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रोथ स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझने में मदद की। मैं���े इनसाइट्स का उपयोग करके कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्�� तक पहुँचा।",
    ...
    finalCta: {
      ...
      cta: "अपना ��ुफ्त क्रिएटर किट अभी प्राप्त करें",
      benefits: [
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और क्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में म���द करता है। चाहे आप अभी शुरुआत कर रहे हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, टूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
आप mail@famechase.com पर ईमेल करके किसी भी समय अपने डेटा को हटाने या सुधार��े का अनुरोध कर सकते हैं।`,
    },
    terms: {
