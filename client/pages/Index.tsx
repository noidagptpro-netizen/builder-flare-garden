  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      premiumUpgrade: {
        ...
        subtitle:
          "अपने कंटेंट को लाभदायक व्यवसाय में बदलने ��े लिए आव���्यक सब कुछ",
        features: [
          "30+ ईमेल टेम्प्लेट्स",
          "लाइव प्रोफाइल पेज",
          "एनालिटिक्स डैशबोर्ड",
    ...
    successStories: {
      ...
      subtitle: "असली क्रिएटर्स, असली परि��ाम, असली आय वृद्धि",
      stories: [
        {
          name: "अनन्या शर्मा",
          role: "ब्यूटी क्रिएटर",
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और ��्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में मदद करता है। चाहे आप अभी शुरुआ�� कर रहे हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, ��ूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
हमारा मिशन सभी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    ...
    contact: {
      title: "📬 संपर्क करें",
      content: `कोई प्रश्��, फीडबैक, या पार्टनरशिप पूछताछ है? हम मदद के लिए यहाँ हैं!
...
• डिवाइस और उपयोग डेटा (कुकीज़ या एना��िटिक्स टूल्स के माध्यम से)
...
आप mail@famechase.com पर ईमेल करके किसी भी समय अपने डेटा को हटाने या सुधारने का अनुरोध कर सकते ���ैं।`,
    },
    terms: {
...
3. बौद्धिक संपदा:
��्रदान की गई सभी सामग्री, डिज़ाइन, और टूल्स FameChase की बौद्धिक संपदा हैं। अनधि��ृत उपयोग निषिद्ध है।
