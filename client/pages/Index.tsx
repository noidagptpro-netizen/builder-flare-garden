...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      ...
      subtitle:
        "केवल 3 मिनट में अपना व्यक्तिगत क���रिएटर ग्रोथ किट, प्रोफेशनल मीडिया किट, और AI-powered रणनीति प्राप्त करें।",
      proofPoints: [
        "100% मुफ्त विश्लेषण",
        "तुरंत डाउनलोड",
        "असली बिज़नेस टूल्स",
      ...
      steps: [
        {
          ...
          description:
            "अपने कंटेंट, ऑडियंस, लक्ष्यों और व���्तमान चुनौतियों के बारे में प्रश्नों के उत्तर दें। हमारा AI सब कुछ विश्लेषित करता है।",
        },
        {
          number: "2",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रो��� स���ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझने में मदद की। मैंने इनसाइट्स का उपयोग करके अपने कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्स तक बढ़ा।",
    ...
    finalCta: {
      title: "अपने कंटेंट क��� निरंतर आय म��ं बद���ने के लिए तैयार हैं?",
      subtitle:
...
हमारा मिशन सभी स्तरों के क्रिएटर्स क��� लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    },
    contact: {
      title: "📬 संपर्क करें",
...
• फॉर्म या खरीदारी के माध्यम से व्यक्तिगत विवरण (���ाम, ईमेल)
...
हम कभी भी आपका डेटा तीसरे पक्ष को नहीं बेचते ��ा साझा नहीं करते। सभी जानकारी सुरक्षित रूप से संग्रहीत की जाती है और केवल सेवा वितरण और सु��ार के लिए उपयोग की जाती है।
