  ...
  hindi: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        {
          number: "2",
          title: "🔍 तुरंत विश्लेषण प्र��प्त करें",
          description:
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और ��्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में मदद करता है। चाहे आप अभी शुरुआत कर रहे हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, ह��� आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, ��ूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
हमारा मिशन सभी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    ...
    contact: {
      title: "📬 संपर्क करें",
      content: `कोई प्रश्न, फीडबैक, या पार्टनरशिप पूछताछ है? हम मदद के लिए यहाँ है��!
...
4. सेवा उपलब्धता:
हम किसी भी समय स���वाओं (मुफ्त या पेड) को संशोधित या बंद करने का अधिकार सुरक्षित रखत�� हैं।
