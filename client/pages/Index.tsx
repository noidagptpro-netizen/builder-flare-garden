...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ��डियंस, और विकास क्षमता का AI-powered विश्लेषण जिसमें कार्यशील सुझाव हैं।",
      ...
      steps: [
        {
          ...
          description:
            "अपने कंट���ंट, ऑडियंस, लक्ष्यों, और वर्तमान चुनौतियों के बारे में प्रश्नों के ��त्तर दें। हमारा AI सब कुछ विश्लेषित करता है।",
        },
        {
          number: "2",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रो��� स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेह��र समझने में मदद की। मैंने इनसाइट्स का उपयोग करके अपने कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्स तक बढ़ा।",
    ...
    finalCta: {
      ...
      subtitle:
        "हजारों क्रिएटर्स से जुड़ें जिन्होंने हमारे सिद्ध ���्रेमवर्क का उपयोग करके ���फल व्यवसाय बनाए हैं",
...
हमारा मिशन सभी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनी���िक, और लाभदायक बनाना है।`,
    },
    contact: {
      title: "📬 संपर्क करें",
