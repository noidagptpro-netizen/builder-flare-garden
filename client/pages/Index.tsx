    ...
    whatYouGet: {
      ...
      deliverables: {
        ...
        mediaKit: {
          ...
          description:
            "आपके आंकड़ों, ऑडियंस डेमोग्राफिक्स, और दर कार्ड के ���ाथ कस्टम-डिज़ाइन मीड��या किट टेम्प्लेट।",
      ...
      premiumUpgrade: {
        ...
        cta: "मुफ्त ���्विज़ शुरू करें और प्रो अनलॉक करें",
      },
    },
    howItWorks: {
      ...
      stories: [
        {
          ...
          avatar: "अ",
          testimonial:
            "प्रोफेशनल मीडिया किट टेम्प्लेट का उप���ोग करके, मैंने 2 सप्��ाह के भीतर अपना पहला ब्रांड कोलैबोरेशन सुरक्षित किया। प्राइसिंग गाइड ने मुझे एक पोस्ट के लिए ₹35K नेगोसिएट करने में मदद की।",
        ...
        },
        {
          ...
          avatar: "मी",
          testimonial:
            "ईमेल टेम्प्लेट्स गेम-चेंजर थे। मैंने उनका उपयोग करके 50 ब्रांड्स तक पहुंचन�� के लिए कि���ा और 12 से रिस्पॉन्स मिला। अब मेरे पास निरंतर मासिक कोलैबोरेशन हैं।",
