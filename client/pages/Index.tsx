...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      ...
      title: "अपने कंटेंट ���ो बदलें",
      titleHighlight: "₹50K+ मासिक आय में",
      subtitle:
        "केवल 3 मिनट में अपना व्यक्तिगत क्रिएटर ग्र���थ किट, प्रोफेशनल मीडिया किट, और AI-powered रणनीति प्राप्त करें।",
      proofPoints: [
        "100% मुफ्त विश्लेषण",
        "तुरंत डाउनलोड",
        "असली ��िजनेस टूल्स",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "���्रो��� स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझने में मदद की। मैंने इनसाइट्स का उपयोग करके अपने कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्स तक बढ़ा।",
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      title: "📄 FameChase के बारे म��ं",
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और ��्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में मदद करता है। चाहे आप अभी शुरुआत कर रहे हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, ��ूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
हमारा मिशन सभी स्तरों के क्���िएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    },
    contact: {
      title: "📬 संपर्क करें",
...
2. भुगतान और रिफंड:
सभी खरीदारी अंतिम हैं। चूंकि हमारे उत्पाद डिजिटल हैं और तुरंत वितरित किए जाते हैं, हम र������ंड की पेशकश नहीं करते।

3. बौद्धिक संपदा:
��्रदान की गई सभी सामग्री, डिज़ाइन, और टूल्स FameChase की बौद्धिक संपदा हैं। अनधिकृत उपयोग निषिद्ध है।
