      ...
      stories: [
        {
          ...
          avatar: "अ",
          testimonial:
            "प्रोफेशनल मीडिया किट टेम्प्लेट का उपयोग करके, म��ंने 2 सप्ताह के भीतर अपना पहला ब्रांड कोलैबोरेशन सुरक्षित किया। प्राइसिंग गाइड ने मुझे एक पोस्ट के लिए ₹35K नेगोसिएट करने में मदद की।",
...
• हमारी सेवाओं और उपयोगकर्ता अन��भव को बेहतर बनाने के लिए
