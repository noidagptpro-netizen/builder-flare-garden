...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑडियंस, और विकास क्षमता का AI-powered विश्लेषण जिसमें कार्यशील सुझाव है���।",
      ...
      premiumUpgrade: {
        ...
        subtitle:
          "अपने कंटेंट को लाभदायक व्य��साय में बदलने के लिए आवश्यक सब कुछ",
        features: [
          "30+ ईमेल टेम्प्लेट्स",
          "लाइव प्रोफाइल पेज",
          "एनालिटिक्स डैशबोर्ड",
    ...
    successStories: {
      ...
      subtitle: "असली क्रिएटर्स, असली पर���णाम, असली आय वृद्धि",
      stories: [
        {
          name: "अनन्या शर्मा",
          role: "ब्यूटी क्रिएटर",
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रोथ स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझने में मदद की। मैंने इनसाइट्स का उपयोग करके कंटेंट को ऑप्टिमाइज़ ��िया और 4 महीने में 5K से 25K फॉलोअर्स तक पहुँचा।",
    ...
    finalCta: {
      ...
      subtitle:
        "हजारों क्रिएटर्स से जुड़ें जिन्होंने हमारे सिद्ध फ्रेमवर्क का उपयोग करके सफ��� व्यवसाय बनाए हैं",
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और क्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में मदद करता है। चाहे आप अभी शुरुआत कर रहे हों या अपन�� ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, टूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
हमारा मिशन सभी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    ...
    contact: {
      title: "📬 संपर्क करें",
      content: `कोई प्रश्न, फीडबैक, या पार्टनर��िप पूछताछ है? हम मदद के लिए यहाँ हैं!
...
• डिवाइस और उपयोग डेटा (कुकीज़ या एनालिटिक्स टूल्स के माध्���म से)
