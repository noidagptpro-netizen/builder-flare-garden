...
const translations = {
  ...
  hindi: {
    ...
    finalCta: {
      ...
      benefits: ["✓ 100% हमेशा के लिए मुफ्त", "✓ तु���ंत प���ुंच", "✓ कोई क्रेडिट कार्ड आवश्यक नह��ं"],
    },
    footer: {
...
• व्यक्तिगत विकास योजनाएं प्रदान करने के ल��ए
...
4. सेवा उपलब्धता:
हम किसी भी समय सेवाओं (मुफ्त या पेड) को संशोधित या बंद करने का अधिक��र सुरक्षित रखते हैं।
