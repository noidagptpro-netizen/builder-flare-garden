...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑडियंस, औ��� विकास क्षमता का AI-powered विश्लेषण जिसमें कार्यशील सुझाव हैं।",
      ...
      steps: [
        {
          ...
          description:
            "अपने कंटेंट, ऑडियंस, लक्ष्यों और वर्तमान चुनौतियों के बारे में प्रश्नों के उत्तर दें। ��मारा AI सब कुछ विश्लेषित करता है।",
        },
        {
          number: "2",
    ...
    finalCta: {
      ...
      subtitle:
        "हजारों क्रिएटर्स से जुड़��ं जिन्होंने हमारे सिद्ध ���्रेमवर्क का उपयोग करके सफल व्यवसाय बनाए हैं",
      cta: "अपना मुफ्त ��्रिएटर किट अभी प्राप्त करें",
      benefits: [
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और ��्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने ���ें मदद करता है। चाहे आप अभी शुरुआत कर रहे हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, ��ूल्स, और डिजिटल उत्पाद प्रदान करते हैं।
...
• ड���वाइस और उपयोग डेटा (कुकीज़ या एनालिटिक्स टूल्स के माध्यम से)
