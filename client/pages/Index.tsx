...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      badge:
        "🏆 भारत का #1 क्रिएटर्��� और मार्केटर्स के लिए ग्रोथ प्लेटफॉर्म - 10,000+ सफलता की कहानियां",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "30 दिनों के भीतर अपना पहला पेड कोलैबोरेशन लैंड क��ने के लिए अपनी मीडिया किट और आउटरीच टेम्प्लेट्स का उपयोग करें।",
        },
      ],
      ...
      stories: [
        {
          ...
          avatar: "अ",
          testimonial:
            "प्रोफेशनल मीडिया किट टेम्प्लेट का उपयोग करके, मैंने 2 सप्ताह के भीतर अपना पहला ब्रांड कोलैबोरेशन सुरक्षित किया। प्राइसिंग गाइड ने मुझे एक पो���्ट के लिए ₹35K नेगोसिएट करने में मदद की।",
        ...
        },
        {
          ...
          avatar: "मी",
          testimonial:
            "ईमेल टेम्प्लेट्स गेम-चेंजर थे। मैंने उनका उपयोग करके 50 ब्रांड्स तक पहुंचने के लिए किया ��र 12 से रिस्पॉन्स मिला। अब मेरे पास निरंतर मासिक कोलैबोरेशन हैं।",
          result: "+12 सक्रिय ब्रांड प���र्टनरशिप",
        },
      ],
    },
    finalCta: {
...
AI-powered रिपोर्ट्स, कस्टम ग्रोथ स्ट्रैटेजीज़, और भारतीय और वैश्विक प्लेटफॉर्म के लिए डिज़ाइन किए गए क्रिएटर ��िट्स के साथ, हम आपके कंटेंट को बढ़ने, ब्रांड करने, औ��� मुद्रीकरण करने को आसान बनाते हैं—चरणबद्ध तरीके से।
...
FameChase में, आपकी गोपनीयता हमारे लिए महत्वपूर्ण है। यह गोपनीयता नीति बताती है कि जब आप हमारी वेबसाइट और सेवाओं का उपय���ग करते हैं तो हम आपकी जानकारी कैसे एकत्र, उपयोग, और सुरक्षित करते हैं।
...
1. सेवा का उपयोग:
��मारी सेव��एं और डिजिटल डाउनलोड व्यक्तिगत, गैर-व्यावसायिक उपयोग के लिए हैं। आप उन्हें पुनर्वितरित, पुनर्विक्रय, या ���ुनर्प्रकाशित नहीं कर सकते।
