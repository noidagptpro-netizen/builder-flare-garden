...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      deliverables: {
        ...
        growthStrategy: {
          ...
          description:
            "कंटेंट आइडिया, पोस्टिंग शेड्यूल, और मुद्रीकरण रोडमै�� के साथ 3-महीने की कार्य योजना।",
          badge: "✓ चरणबद्ध गाइड",
        },
      },
      premiumUpgrade: {
    ...
    finalCta: {
      title: "अपने कंटेंट क��� निरंतर आ��� में बद���ने के लिए तैयार हैं?",
      subtitle:
...
AI-powered रिपोर्ट्स, कस्टम ग्रोथ स्ट्रैटेजीज़, और भारतीय और वैश्विक प्लेटफॉर्म के लिए डिज़ाइन किए गए क्रिएटर किट्स के साथ, हम आपके कंटेंट को बढ़ने, ब्रांड करने, औ��� मुद्री��रण करने को आसान बनाते हैं—चरणबद्ध तरीके से।
...
FameChase में, आपकी गोपनीयता हमारे लिए महत्वपूर्ण है। यह गोपनीयता नीति बताती है कि जब आप हमारी वेबसाइट और सेवाओं का उपयोग करते हैं तो हम आपकी जानकारी कैसे एकत्र, उपयोग, और सुरक्षित क���ते हैं।
...
हम कभी भी आपका डेटा तीसरे पक्ष को नहीं बेचते ��ा साझा ��हीं करते। सभी जानकारी सुरक्षित रूप से संग्रहीत की जाती है और केवल सेवा वितरण और सुधार के लिए उपयोग की जाती है।
...
2. भुगतान और रिफंड:
सभी खरीदारी अ���तिम हैं। चूंकि हमारे उत्पाद डिजिटल हैं और तुरंत वितरित किए जाते हैं, हम रि���ंड की पेशकश नहीं करते।
