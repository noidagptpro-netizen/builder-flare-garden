...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      ...
      subtitle:
        "केवल 3 मिनट में अपन��� व्यक्तिगत क्रिएटर ग्रोथ किट, प्रोफेशनल मीडिया किट, और AI-powered रणनीति प्राप्त करें।",
      proofPoints: [
        "100% मुफ्त विश्लेषण",
        "तुरंत डाउनलोड",
        "असली बिज़नेस टूल्स",
    ...
    howItWorks: {
      ...
      ctaSubtext:
        "10,000+ क्रिए��र्स से ज���ड़ें जिन्होंने अपने जुनून को लाभ में बदला है",
    },
    successStories: {
...
हमारा मिशन ���भी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    },
    contact: {
      title: "📬 संपर्क करें",
...
• फॉर्म या खरीदारी के म��ध्यम से व्यक्तिगत विवरण (नाम, ईमेल)
...
हम कभी भी आपका डेटा तीसरे पक्ष को नहीं बेचते ��ा साझा नहीं करते। सभी जानकारी सुरक्षित रूप से संग्रहीत की जाती ह��� और केवल सेवा वितरण और सुधार के लिए उपयोग की जाती है।
