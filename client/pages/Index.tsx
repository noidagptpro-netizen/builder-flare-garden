...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      ...
      subtitle:
        "��ेवल 3 मिनट में अपना व्यक्तिगत क्रिएटर ग्रोथ किट, प्रोफेशनल मीडिया किट, और AI-powered रणनीति प्राप्त करें।",
      proofPoints: [
        "100% मुफ्त विश्लेषण",
        "तुरंत डाउनलोड",
        "असली बिज़नेस टूल्स",
      ...
      steps: [
        {
          ...
          description:
            "अप��े कंटेंट, ऑडियंस, लक्ष्यों और वर्तमान चुनौतियों के बारे में प्रश्नों के उत्तर दें। हमारा AI सब कुछ विश्लेषित करता है।",
        },
        {
          number: "2",
    ...
    finalCta: {
      title: "अपने ���ंटेंट को निरंतर आय में बदलने के लिए तैयार हैं?",
      subtitle:
        "हजारों क्रिएटर्स से जुड़ें जिन्���ोंने हमारे सिद्ध फ्रेमवर्क का उपयोग करके सफल व्यवसाय बनाए हैं",
...
हमारा मिशन सभी स्तरों के क्रिए��र्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    },
    contact: {
      title: "📬 संपर्क करें",
