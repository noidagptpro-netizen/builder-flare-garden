...
const translations = {
  ...
  hindi: {
    ...
    howItWorks: {
      ...
      cta: "अपनी क्रिएटर यात्रा अभी शुरू ��रें",
      ctaSubtext:
...
हम कभी भी आपका डेटा तीसरे पक्ष को नहीं बेचते ��ा साझा नहीं करते। सभी जानकारी सुरक्षि��� रूप से संग्रहीत की जाती है और केवल सेवा वितरण और सुधार के लिए उपयोग की जाती है।
...
2. भुगतान और रिफंड:
सभी खरीदारी अंतिम हैं। चूंकि हमारे उत्पाद ड��जिटल हैं और तुरंत वितरित किए जाते हैं, हम रि���ंड की पेशकश नहीं करते।
