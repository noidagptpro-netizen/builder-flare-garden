...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      badge:
        "🏆 भारत का #1 क्रिएटर्स और मार्केटर्स के लिए ग्रोथ प्ले���फॉर्म - 10,000+ सफलता की कहानियां",
    ...
    whatYouGet: {
      ...
      subtitle:
        "अ���ना क्विज़ पूरा करें और ₹10,000+ मूल्य के प्रोफेशनल टूल्स तक बिल्क��ल मुफ्त तुरंत पहुंच प्राप्त करें",
      deliverables: {
        fameScore: {
        ...
        growthStrategy: {
          ...
          description:
            "क���टेंट आइडिया, पोस्टिंग शेड्यूल, और मुद्रीकरण रोडमैप के साथ 3-महीने की कार्य योज���ा।",
          badge: "✓ चरणबद्ध गाइड",
        },
      },
      premiumUpgrade: {
    ...
    howItWorks: {
      ...
      subtitle: "अज्ञात क्रिएटर से आय कमा���े वाले तक केवल 3 सरल चरणों ���ें",
      steps: [
        {
          number: "1",
        ...
        },
        {
          ...
          description:
            "30 दिनों के भीतर अपना पहला पेड कोलैबोरेशन लैंड करने के लिए अपनी म��डिया किट और आउटरीच टेम्प्लेट्स का उपयोग करें।",
        },
      ],
      ...
      stories: [
        {
          ...
          avatar: "अ",
          testimonial:
            "प्रोफेशनल मीडिया किट टेम्प्लेट का उपयोग करके, मैंने 2 सप्ताह के भीतर अपना पहला ब्रांड कोलैबोरेशन सुरक्षित किया। प्राइसिंग गाइड ने मुझे एक पोस्ट के लिए ₹35K नेग���सिएट करने में मदद की।",
...
FameChase में, आपकी गोपनीयता हमारे लिए महत्वपूर्ण है। यह गोपनीयता नीति बताती है कि जब आप हमारी वेबसाइट और सेवाओं का उपयोग क���ते हैं तो हम आपकी जानकारी कैसे एकत्र, उपयोग, और सुरक्षित करते हैं।
...
1. सेवा का उपयोग:
��मारी सेव��एं और डिजिटल डाउनलोड व्यक्तिगत, गैर-व्यावसायिक उपयोग के लिए हैं। आप उन्हें पुनर्वितरित, पुनर्विक्रय, या पुनर��प्रकाशित नहीं कर सकते।
