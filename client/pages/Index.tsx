  ...
  hindi: {
    ...
    howItWorks: {
      ...
      steps: [
        ...
        {
          number: "2",
          title: "🔍 तुरंत विश्लेषण ��्राप्त करें",
    ...
    finalCta: {
      ...
      cta: "अपना मुफ्त क्रिएटर किट अभी प्रा��्त करें",
...
4. सेवा उपलब्धता:
हम किसी भी समय सेवाओं (मुफ्त या पेड) को संशोधित या बंद करने का अधिका�� सुरक्षित रखते हैं।
