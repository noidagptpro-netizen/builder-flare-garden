...
const translations = {
  ...
  hindi: {
    ...
    hero: {
      ...
      subtitle:
        "केवल 3 मिनट में अपना व्यक्तिगत क्रिएटर ग्रोथ किट, प्रोफेशनल मीडिया किट, और AI-powered ��णनीति प्राप्त करें।",
      proofPoints: [
        "100% मुफ्त विश्लेषण",
        "तुरंत डाउनलोड",
        "असली बिज़नेस टूल्स",
    ...
    whatYouGet: {
      ...
      deliverables: {
        fameScore: {
          ...
          description:
            "आपके कंटेंट, ऑड��यंस, और विकास क्षमता का AI-powered विश्लेषण जिसमें कार्यशील सुझाव हैं।",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रोथ स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझने में ���दद की। मैंने इनसाइट्स का उपयोग करके कंटेंट को ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्स तक पहुँचा।",
    ...
    finalCta: {
      ...
      subtitle:
        "हजारों क्रिएटर्स स�� जुड़ें जिन्होंने हमारे सिद्ध फ्रेमवर्क का उपयोग करके सफल व्यवसाय बनाए हैं",
...
• व्यक्तिगत परिणाम उत्��न्न करने के लिए क्विज़ प्रतिक्रि���ाएं
...
आप mail@famechase.com पर ईमेल करके किसी भी समय अपने ��ेटा को हटाने या सुधारने का अनुरोध कर सकते हैं।`,
    },
    terms: {
