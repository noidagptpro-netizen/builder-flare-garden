...
const translations = {
  ...
  hindi: {
    ...
    whatYouGet: {
      ...
      subtitle:
        "अपना क्विज़ पूरा करें और ₹10,000+ मूल्य के प्रोफेशनल ट��ल्स तक बिल्क��ल मुफ्त तुरंत पहुंच प्राप्त करें",
      deliverables: {
        fameScore: {
        ...
        growthStrategy: {
          ...
          description:
            "कंटेंट आइडिया, पोस्टिंग शेड्यूल, और मुद्रीकरण रोड���ैप के साथ 3-महीने की कार्य योज���ा।",
          badge: "✓ चरणबद्ध गाइड",
        },
      },
      premiumUpgrade: {
        ...
        subtitle:
          "अपने कंटेंट को लाभदायक व्यवसाय ��ें बदलने के लिए आव���्यक सब कुछ",
        features: [
          "30+ ईमेल टेम्प्लेट्स",
          "लाइव प्रोफाइल पेज",
          "एनालिटिक्स डैशबोर्ड",
    ...
    howItWorks: {
      ...
      subtitle: "अज्ञात क्रिएटर से आय कमाने वाले तक केवल 3 सरल चरणों ���ें",
      steps: [
        {
          number: "1",
    ...
    successStories: {
      ...
      stories: [
        ...
        },
        {
          ...
          avatar: "वि",
          testimonial:
            "ग्रो��� स्ट्रैटेजी ने मुझे अपने ऑडियंस को बेहतर समझने में मदद की। मैंने इनसाइट्स का उपयोग करके अपने कंटेंट क�� ऑप्टिमाइज़ किया और 4 महीने में 5K से 25K फॉलोअर्स तक बढ़ा।",
    ...
    finalCta: {
      title: "अपने कंटेंट क��� निरंतर आय में बद���ने के लिए तैयार हैं?",
      subtitle:
        "हजारों क्रिएटर्स से जुड़ें जिन्होंने हमारे सिद्ध ���्रेमवर्क का उपयोग करके सफल व्यवसाय बनाए हैं",
      cta: "अपना मुफ्त क्रिएटर किट अभी प्राप्त ���रें",
      benefits: [
...
For any questions, email us at mail@famechase.com`,
  ...
  hindi: {
    about: {
      ...
      content: `FameChase इच्छुक इन्फ्लुएंसर्स और ��्रिएटर्स को उनकी विकास क्षमता को अनलॉक करने में मदद करता है। चाहे आप ���भी शुरुआत कर रहे हों या अपने ऑडियंस को आय में बदलना चाह रहे हों, हम आपकी यात्रा को तेज़ करने के लिए व्यक्तिगत अंतर्दृष्टि, ��ूल्स, और डिजिटल उत्पाद प्रदान करते हैं।

AI-powered रिपोर्ट्स, कस्टम ग्रोथ स्ट्रैटेजीज़, और भारतीय और वैश्विक प्लेटफॉर्म के लिए डिज़ाइन किए गए क्रिएटर किट्स के साथ, हम आपके कंटेंट को बढ़ने, ब्रांड करने, औ��� मुद्रीकरण करने को आसान बनाते हैं—चरणबद्ध तरीके से।

हमारा मिशन सभी स्तरों के क्रिएटर्स के लिए इन्फ्लुएंसर सफलता को सुलभ, रणनीतिक, और लाभदायक बनाना है।`,
    },
    contact: {
      title: "📬 संपर्क करें",
      content: `���ोई प्रश्न, फीडबैक, या पार्टनरशिप पूछताछ है? हम मदद के लिए यहाँ हैं!

📧 हमें ईमेल करें: mail@famechase.com`,
    },
    privacy: {
      title: "🔒 गोपनीयता नीति",
      content: `प्रभावी तिथि: 9 ��ुलाई, 2025

FameChase में, आपकी गोपनीयता हमारे लिए महत्वपूर्ण है। यह गोपनीयता नीति बताती है कि जब आप हमारी वेबसाइट और सेवाओं का उपयोग करते हैं तो हम आपकी जानकारी कैसे एकत्र, उपयोग, और सुरक्षित करते हैं।

1. हम क्या एकत्र करते हैं:
• फॉर्म या खरीदारी के माध्यम से व्यक्तिगत विवरण (नाम, ईमेल)
• व्यक्तिगत परिणाम उत्��न्न करने के लिए क्विज़ प्रतिक्रियाएं
• डिवाइस और उपयोग डेटा (कुक��ज़ या एनालिटिक्स टूल्स के माध्यम से)

2. हम इसका उपयोग कैसे करते हैं:
• व्यक्तिगत विकास योजनाएं प्रदान करने के लिए
• डाउनलोड योग्य सामग्री वितरित करन�� के लिए
�� हमारी सेवाओं और उपयोगकर्ता अनुभव को बेहतर बनाने के लिए
• अपडेट्स और ऑफर्स संवाद करने के लिए

3. आपका डेटा सुरक्षित है:
हम कभी भी आपका डेटा तीसरे पक्ष को नहीं बेचते ��ा साझा नहीं करते। सभी जानकारी सुरक्षित रूप से संग्रहीत की जाती है और केवल सेवा वितरण और सुधार के लिए उपयोग की जाती है।

आप mail@famechase.com पर ईमेल करके किसी भी समय अपने डेटा को हटाने या सुधारने का अनुर��ध कर सकते हैं।`,
    },
    terms: {
      title: "📜 नियम और शर्तें (T&C)",
      content: `प्रभावी तिथि: 9 जुलाई, 2025

FameChase.com का उपयोग करके, आप निम्नलिखित शर्तों से सह��त हैं:

1. सेवा का उपयोग:
��मारी सेव��एं और डिजिटल डाउनलोड व्यक्तिगत, गैर-व्यावसायिक उपयोग के लिए हैं। आप उन्हें पुनर्वितरित, पुनर्विक्रय, या पुनर्प्रकाशित नहीं कर सकते।

2. भुगतान और रिफंड:
सभी खरीदारी अंतिम हैं। चूंकि हमारे उत्पाद डिजिटल हैं और तुरंत वितरित किए जाते हैं, हम रि���ंड की पेशकश नहीं करते।

3. बौद्धिक संपदा:
��्रदान की गई सभी सामग्री, डिज़ाइन, और टूल्स FameChase की बौद्धिक संपदा ���ैं। अनधिकृत उपयोग निषिद्ध है।

4. सेवा उपलब्धता:
हम किसी भी समय सेवाओं (मुफ्त या पेड) को संशोधित या बंद करने का अधिकार सुरक्षित रखत�� हैं।

5. संपर्क:
किसी भी प्रश्न के ल��ए, हमें mail@famechase.com पर ईमेल करें`,
    },
  },
};
