...
const languages = {
  ...
  hindi: {
    ...
    unlock: "अपना संपूर्ण क्रिएटर टूलकिट अन���ॉक करे���",
    unlockSubtitle:
...
${language === "hindi" ? "2. ब्रांड पार्टनरशिप के लिए तैयार हो जा���ं" : "2. Prepare for brand partnerships"}
...
${language === "hindi" ? "- दैनिक एंगेजमेंट ���ेट" : "- Daily engagement rate"}
...
1. ${language === "hindi" ? "मिनिमम रेट हमेशा ₹" + Math.round(followerNum * 0.008).toLocaleString() + "/पोस्��� रखें" : "Never charge less than ₹" + Math.round(followerNum * 0.008).toLocaleString() + "/post"}
...
│ ${language === "hindi" ? "ब्रांड इंक्वायरी" : "Brand Inquiries"}: _____ (टार��ेट: ${Math.round(currentFollowers / 5000)})   │
...
│ ${language === "hindi" ? "स्टोरी व���यूज" : "Story Views"}: _____ (टारगेट: 40-60%) │
└─────────────────────────────────────────────┘
