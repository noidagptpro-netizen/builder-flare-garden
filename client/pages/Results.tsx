...
const languages = {
  ...
  hindi: {
    ...
    marketInsights: "बाजार अं��र्दृष्टि",
  },
};
...
${language === "hindi" ? "������म स्कोर:" : "Fame Score:"} ${analysis.fameScore}/100
${language === "hindi" ? "एंगेजमेंट रेट:" : "Engagement Rate:"} ${language === "hindi" ? "उच्च गुणवत्त���" : "High Quality"}
...
${language === "hindi" ? "- नेटवर्किंग ���र सहयोग" : "- Networking and collaborations"}
...
${language === "hindi" ? "📊 दैनिक ट्रैकिंग मेट्रिक्स:" : "📊 DAILY TRACKING METRICS:"}
═══════════════════════════════════════

${language === "hindi" ? "कंटेंट परफॉर्मेंस:" : "CONTENT PERFORMANCE:"}
...
${language === "hindi" ? "📈 साप्ताहिक समीक्षा चेकलिस्ट:" : "📈 WEEKLY REVIEW CHECKLIST:"}
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-2xl p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "साबित किए गए टूल्स जो टॉप क्रिएटर्स अपनी आय 5X ��ढ़ाने के लिए इस्तेमाल करते हैं। यह सब कुछ बिल्कुल फ्री है!"
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-purple-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    {language === "hindi"
                      ? "वही ट्रैकिंग सिस्टम जो मिलियन-फॉलोअर क्रिएटर्स इस्तेमाल कर��े हैं। अपनी ROI को 300% तक बढ़ाएं।"
              ...
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-4">
                <p className="text-amber-800 font-medium text-center">
                  {language === "hindi"
                    ? "🎯 इन टूल्स की कीमत बाजार में ₹5,000+ है - लेकिन आपको ये बिल्कुल फ���री मिल रहे हैं!"
