              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white rounded-xl p-6 border border-purple-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    {language === "hindi"
                      ? "जानें कि आप हर महीने कितना कमा सकते हैं। टॉप क्रिएटर्स के डेटा पर आध��रित 95% सटीक कैलकुलेशन।"
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700">
                      {language === "hindi"
                        ? `आप ${quizData.niche} में कंटेंट बनाते हैं - यह ���क बहुत डिमांडिं��� निच है जहाँ ब्रांड्स ${quizData.followerCount.includes("1K") ? "3-5" : quizData.followerCount.includes("10K") ? "10-15" : "20+"} लाख रुपए सालाना खर्च करते हैं।`
                    ...
                    <div key={index} className="flex items-start gap-3">
                      ...
                      <p className="text-gray-700">
                        ...
                        {challenge.includes("Algorithm") && (language === "hindi"
                          ? "Algorithm के साथ बेहतर relationship के लिए engagement rate 5%+ रखें।"
