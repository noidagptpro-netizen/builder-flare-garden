...
const languages = {
  ...
  hindi: {
    ...
    competitorAnalysis: "प���रति���ोगी विश्लेष��",
...
${language === "hindi" ? "- एंग���जमेंट मेट्रिक्स में स���धार" : "- Improve engagement metrics"}
...
${language === "hindi" ? "- मासिक ��्रांड इंक्वायर��" : "- Monthly brand inquiries"}
...
${language === "hindi" ? "निच:" : "Niche:"} ${quizData.niche}
${language === "hindi" ? "निच मल्टीप्लायर:" : "Niche Multiplier:"} ${nicheMultiplier}x

${language === "hindi" ? "💰 अनुमानित मासिक आय:" : "💰 ESTIMATED MONTHLY INCOME:"}
${language === "hindi" ? "न्यूनतम:" : "Minimum:"} ₹${Math.round(monthlyPotential * 0.6).toLocaleString()}
${language === "hindi" ? "औसत:" : "Average:"} ₹${monthlyPotential.toLocaleString()}
...
${language === "hindi" ? "🎯 ग्रोथ प्रोजेक्शन (अगले 6 महीने):" : "🎯 GROWTH PROJECTION (Next 6 months):"}
...
${language === "hindi" ? "आपका फॉर्मूला:" : "Your Formula:"} ${followerNum} × ₹0.8 × ${nicheMultiplier} = ₹${monthlyPotential}`;
      ...
      content =
        fontSizeIndicator +
        `${language === "hindi" ? "प्रीमियम एनालिटिक्स ट्रैकर टेम्प्लेट" : "PREMIUM ANALYTICS TRACKER TEMPLATE"} - ${userName}

${language === "hindi" ? "📊 व्यक्तिगत ट्रैकिंग डैशबोर्ड:" : "📊 PERSONALIZED TRACKING DASHBOARD:"}
═══════════════════════════════════════

${language === "hindi" ? "👤 आपकी जानकारी:" : "👤 YOUR PROFILE:"}
${language === "hindi" ? "नाम:" : "Name:"} ${userName}
${language === "hindi" ? "मुख्य प्लेटफॉर्म:" : "Primary Platform:"} ${quizData.primaryPlatform || "Not specified"}
${language === "hindi" ? "निच:" : "Niche:"} ${quizData.niche || "Not specified"}
${language === "hindi" ? "वर्तमान फॉलोअर्स:" : "Current Followers:"} ${quizData.followerCount || "Not specified"}
${language === "hindi" ? "मासिक आय लक्ष्य:" : "Monthly Income Goal:"} ${quizData.monthlyIncome || "Not specified"}

${language === "hindi" ? "कंटेंट परफॉर्मेंस ट्रैकिंग:" : "CONTENT PERFORMANCE TRACKING:"}
- ${language === "hindi" ? "पोस्ट रीच" : "Post Reach"}: [Enter daily reach]
- ${language === "hindi" ? "एंगेजमेंट रेट" : "Engagement Rate"}: [Calculate: (Likes+Comments+Shares)/Reach]
- ${language === "hindi" ? "इंप्रेशन" : "Impressions"}: [Total views]
- ${language === "hindi" ? "सेव रेट" : "Save Rate"}: [Saves/Reach × 100]
...
- ${language === "hindi" ? "ब्रांड इंक्वायरी" : "Brand Inquiries"}: [Count]
- ${language === "hindi" ? "कोलैबोरेशन रेट" : "Collaboration Rate"}: [₹ amount]
- ${language === "hindi" ? "कन्वर्जन रेट" : "Conversion Rate"}: [Inquiries to deals]

${language === "hindi" ? "📈 साप्��ाहिक समीक्षा चेकलिस्ट:" : "📈 WEEKLY REVIEW CHECKLIST:"}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-neon-green transition-colors">
                ...
                <p className="text-gray-600 mb-6">
                  {language === "hindi"
                    ? "आपक�� व्यक्तिगत 90-दिन की विकास रणनीति"
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-2xl p-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "हमारे ��डवांस्ड प्रीमिय��� कोर्सेज के साथ अपनी क्रिएटर यात्रा को तेज़ी से आगे बढ़ाएं।"
