...
const languages = {
  ...
  hindi: {
    ...
    unlockSubtitle:
      "अपनी व्यक्तिगत फेम स्कोर रिपोर्ट, प्रोफेशनल मीडिया किट टेम्प्लेट, और ग्रोथ स्ट्रैटेजी + हमारे संपूर्ण प्रीमियम क्रिएटर टूल्स तक पहुँच प्राप्त करें।",
...
${language === "hindi" ? "3. अपने एंगेजमेंट मेट्रिक्स को ब�����तर बनाएं" : "3. Improve your engagement metrics"}
...
${language === "hindi" ? "सुझावित दरें (भारत���य बाजार आधारि��):" : "SUGGESTED RATES (Indian Market Based):"}
...
${language === "hindi" ? "📊 रियल-टाइम म���र्केट एन���लिसिस रिपोर्ट" : "📊 REAL-TIME MARKET ANALYSIS REPORT"}
═══════════════════════════════════════════════════
...
${language === "hindi" ? "स्टैंडर्ड पै���ेज:" : "Standard Package:"} ₹${Math.round(followerNum * 0.025 * niche.multiplier).toLocaleString()}
${language === "hindi" ? "प्रीमियम पैकेज:" : "Premium Package:"} ₹${Math.round(followerNum * 0.045 * niche.multiplier).toLocaleString()}

${language === "hindi" ? "⏱️ ल���स्ट अपडेटेड:" : "⏱️ Last Updated:"} ${new Date().toLocaleDateString()} - ${new Date().toLocaleTimeString()}`;
      ...
      content =
        fontSizeIndicator +
        `${language === "hindi" ? "💎 प्रो-लेवल एनालिटिक्स मास्टर ट्���ैकर" : "💎 PRO-LEVEL ANALYTICS MASTER TRACKER"} - ${userName}
...
${language === "hindi" ? "📈 प्रीम��यम परफॉर्मेंस ट्रैकिंग मेट्रिक्स:" : "📈 PREMIUM PERFORMANCE TRACKING METRICS:"}
...
4. ${language === "hindi" ? "पहले 30 मिनट में ज���यादा likes = Algorithm boost" : "High likes in first 30 minutes = Algorithm boost"}
...
□ ${language === "hindi" ? "Audience insights देखें - कब ऑनलाइन हैं, demographics" : "Review audience insights - when online, demographics"}
□ ${language === "hindi" ? "नए ट्रेट�ड्स research करें और next week plan करें" : "Research new trends and plan next week content"}
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-neon-green transition-colors">
                ...
                <p className="text-gray-600 mb-6">
                  {language === "hindi"
                    ? "आपका व्यक्तिगत फेम स���को��� ��र विस्तृत विश्लेषण"
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:border-neon-green transition-colors">
                ...
                <p className="text-gray-600 mb-6">
                  {language === "hindi"
                    ? "ब्र��ंड��स के लिए आपकी प्रोफेशनल मीडिय��� किट"
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-2xl p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "साबित किए गए टूल्स जो टॉप क्रिएटर्स अपनी आय 5X ��ढ़ाने के �����ए इस्तेमाल करते हैं। ����� सब कुछ बिल्कुल फ्री है!"
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-purple-200">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    {language === "hindi"
                      ? "वही ट्रैकिंग सिस्टम जो मिलियन-फॉलोअर क्रिएटर्स इस्��ेमाल कर��े हैं। अपनी ROI को 300% तक बढ़ाए��।"
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-8 mb-8">
              ...
              <p className="text-gray-600 mb-6">
                {language === "hindi"
                  ? "आपके quiz responses के आध���र पर, हमारे AI ने ये specific tools recommend किए हैं जो आपकी exact needs जो पूरा करेंगे।"
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <button
                  onClick={() => {
                    const shareText =
                      language === "hindi"
                        ? `मैंने FameChase.com पर अपना Creator Analysis किया! मे���ा Fame Score ${analysis.fameScore}/100 है 🚀`
          ...
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 rounded-2xl p-8 mb-8 shadow-lg">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <Sparkles className="w-6 h-6 text-purple-600" />
              {language === "hindi"
                ? "AI-Powered विश्लेषण - आपके लिए वि��ेष"
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700">
                      {language === "hindi"
                        ? `आप ${quizData.niche} में कंटेंट बनाते हैं - यह ���क बहुत डिमांडिं��� नि��� है जहाँ ब्रांड्स ${quizData.followerCount.includes("1K") ? "3-5" : quizData.followerCount.includes("10K") ? "10-15" : "20+"} लाख रुपए साला���ा खर्च ��रते हैं।`
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                ...
                <div className="text-xs text-gray-500 mt-1">
                  {quizData.secondaryPlatforms.length > 0
                    ? `+${quizData.secondaryPlatforms.length} ${language === "hindi" ? "��र प्लेटफॉ��्��" : "more platforms"}`
                    : language === "hindi"
                      ? "Single platform"
                      : "Single platform"}
                </div>
