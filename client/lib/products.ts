...
export const productConfigs: ProductConfig[] = [
  ...
  },
  {
    ...
    category: "course",
    features: [
      "4-hour video training (Step-by-step viral formula)",
...
आप��े proposal के लिए thank you! मैं definitely interested हूं।
...
[इसी तरह से 24 और templates continue ���रें different scenarios ���े लिए...]`;
  }
...
💰 तीस���े 30 दिन - मुद्रीक��ण और म��र्केटिंग:
...
• क��� competition, बेहतर engagement
...
📈 परफेक्ट हैशटैग मिक्स (30 हैशट���ग):
...
20. "[निच] के बारे में तथ्य ���ो आप नहीं जानते"
...
• ट्रेंडि��ग म्यूज��क का इस्तेमाल करें
...
• श��यर्स और saves (strong engagement signals)
• कम��ंट रेस्पॉन्स रेट
...
🎆 याद रखें:
“सफलता रातोंरात न��ीं आती। ये सभी creators ने वर्षों की मेहनत, लगन और निरंतर सीखने के बाद यह मुकाम हासिल किया है।”`;
  }
...
• Additional value ज���से [extra services] provide कर सकता हूं
...
• Numbers और power words use करें ("5 तरीके", "आसा��", "तुरंत")
...
• File size: Under 2MB
• Format: JPG (smaller file) ���ा PNG (better quality)
...
• "मै��ने [time period] में [achievement] किया"
...
📈 GROWTH HACKS:
• Current members को invite करने के लिए encourage क�����ं
...
You: "मैं appreciate करता हू��� आपकी transparency। ₹5K में हम एक story series create कर सकते हैं, लेकिन complete post integration के लिए मेरा standard rate ₹10K है क्योंकि इसमें professional photography, content creation, और guaranteed engagement included है। क्या हम middle ground find कर सकते हैं?"
